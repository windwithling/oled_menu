...
unsigned char string1[] = "MPU6050 ERROR";
unsigned char string2[] = "MPU6050 READY";
...
void OLED_Show_BMP(int x0,int y0,int width,int height,const unsigned char BMP[])
{
...
void OLED_Show(u8 x,u8 y,u16 bytenumber, u8 height, u8* Image)  
{  
    u16 i=0;  
    u8 y0=y, temp=0, j=0;  
